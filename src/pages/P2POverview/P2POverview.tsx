    ...
    <div class={styles.page}>
      <section class={styles.hero}>
        ...
        <div class={styles.subtitle}>
          Anonymous-by-default connections, educational-only cultural context, and censorship
          resistance.
        </div>
        <div class={styles.pill}>
          <Network size={12} /> Internet + TOR
        </div>
      ...
      <div class={styles.grid}>
        <Card class={`${styles.card} ${styles.wide}` as string}>
          <div class={styles.cardTitle}>
            <Network size={16} /> How your connection flows
          </div>
          <svg class={`${styles.diagram} ${styles.svgFlow}`} viewBox="0 0 800 240">
            ...
            <text x="80" y="124" text-anchor="middle" font-size="10">
              You
            </text>
            ...
            <rect
              ...
              stroke-width="2"
            />
            <text x="345" y="124" text-anchor="middle" font-size="10">
              Tor SOCKS
            </text>
            ...
            <rect
              ...
              stroke-width="2"
            />
            <text x="615" y="124" text-anchor="middle" font-size="10">
              Onion Service
            </text>
          </svg>
          <div class={styles.legend}>
            ...
            <span class={styles.chip}>
              <Globe size={12} /> No public IP exposure
            </span>
            <span class={styles.chip}>
              <Shield size={12} /> Info-only cultural context (no gating)
            </span>
          </div>
        </Card>
        ...
        <Card class={styles.card as string}>
          <div class={styles.cardTitle}>
            <Globe size={16} /> What happens when you click "Enable TOR"
          </div>
          <ol class={styles.steps}>
            <li class={styles.step}>
              We check if Tor Browser SOCKS is running (127.0.0.1:9150). If not, we start the
              bundled tor.
            </li>
            <li class={styles.step}>
              We establish a SOCKS route and request a fresh circuit for anonymity.
            </li>
            <li class={styles.step}>
              We initialize a P2P node configured to never apply cultural filtering.
            </li>
            <li class={styles.step}>
              We discover peers and hidden services and start searching/sharing over Tor.
            </li>
          </ol>
        </Card>
        ...
        <Card class={styles.card as string}>
          <div class={styles.cardTitle}>
            <Shield size={16} /> Your privacy & cultural guarantees
          </div>
