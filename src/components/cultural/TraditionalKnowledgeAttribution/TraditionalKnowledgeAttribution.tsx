  ...
  return (
    <div class={styles.traditionalKnowledgeAttribution}>
      ...
      <Show when={showEducational()}>
        <Card
          class={styles.educationalPanel}
          title="Attribution & Provenance - Educational Context"
        >
      ...
      {/* Primary Attribution */}
      <Card class={styles.primaryAttribution} title="Primary Attribution">
            ...
            <div class={styles.ownershipSection}>
              ...
              <div class={styles.ownershipCard}>
                ...
                <div class={styles.ownershipType}>
                  <strong>Type:</strong> {selectedAttribution().traditionalOwnership!.ownershipType}
                </div>
          ...
          <div class={styles.verificationSection}>
            ...
            <div class={styles.verificationCard}>
              ...
              <div class={styles.verificationDate}>
                ...
                {new Date(selectedAttribution().verification.verificationDate).toLocaleDateString()}
              </div>
      ...
      >
        <Card
          class={styles.alternativeAttributions}
          header={
            <div>
              <h3 class={styles.contentTitle}>Alternative Attributions</h3>
      ...
      <Show when={showProvenanceDetails() && selectedAttribution().provenanceChain.length > 0}>
        <Card
          class={styles.provenanceChain}
          header={
            <div>
              <h3 class={styles.contentTitle}>Provenance Chain</h3>
      ...
      >
        <Card
          class={styles.communityAcknowledgments}
          header={
            <div>
              <h3 class={styles.contentTitle}>Community Acknowledgments</h3>
      ...
      <Show when={props.content.educationalContext}>
        <Card class={styles.educationalAttribution} title="Educational Attribution Context">
      ...
      >
        <div class={styles.notesModalContent}>
          ...
          <Textarea
            ...
            onInput={v => setAdditionalNotes(v)}
