...
export const StorageWidget: Component = () => {
  ...
  return (
    <div class={styles.widget}>
      ...
      <Show when={info()} fallback={<div class={styles.skeleton} />}>
        <div class={styles.bar}>
          <div
            class={styles.fill}
            style={{ width: `${Math.min(100, info()!.disk_usage_percentage).toFixed(1)}%` }}
          />
        </div>
        <div class={styles.meta}>
          <span>
            {formatGB(info()!.used_disk_space_bytes)} / {formatGB(info()!.total_disk_space_bytes)}
          </span>
